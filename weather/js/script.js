	            ...
	            success: function (tiempo) {
	              ...
	              $('.location').append(location);
								...
								switch(weather){
									...
									case ('Cloudy'):
									case ("Mostly Cloudy"):
										$('.icon').append('<img src="images/overcast.png" />')
										break;
									case ('Scattered Clouds'):
									case ('Partly Cloudy'):
										$('.icon').append('<img src="images/scattered-clouds.png" />')
										break;
									case ('Clear'):
										$('.icon').append('<img src="images/clear.png" />')
										break;
									case ('Sunny'):
										$('.icon').append('<img src="images/sunnny.png" />')
										break;
									case ('Rain'):
										case ('Chance of Rain'):
									case('Thunderstom'):
									case('Thunderstorms'):
										$('.icon').append('<img src="images/rain.png" />')
										break;
								}
								...
								for(var i=1; i<6;i++){
									...
									var abrv =""
												...
												switch(weekdayWeather){
													...
													case ('Mostly Sunny'):
													case ('Partly Sunny'):
														var weekdayIcon = '<img src="images/scattered-clouds.png" />';
														break;
													case ('Overcast'):
													case ('Cloudy' ):
													case ('Mostly Cloudy'):
														var weekdayIcon = '<img src="images/overcast.png" />';
														break;
													case ('Clear'):
														var weekdayIcon = '<img src="images/clear.png" />';
														break;
													case ('Sunny'):
														var weekdayIcon = '<img src="images/sunny.png" />';
														break;
													case ('Rain'):
													case ('Chance of Rain'):
													case('Showers'):
													case ('Thunderstorm'):
													case('Thunderstorms'):
														var weekdayIcon = '<img src="images/rain.png" />';
														break;
												}
